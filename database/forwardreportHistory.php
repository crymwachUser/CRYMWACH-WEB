...
if (isset($_POST['edit-btn'])) {
    ...
    $query = "SELECT * FROM forwarddatahistory WHERE forwardid = :forwardid";
...
?>
        ...
        <form id="modalForm">
            ...
            <label for="datereported">Date Forwarded:</label>
            <input type="text" id="datereport" class="text" name="datereport" value="<?php echo $report['dateforward'] ?>" readonly>
            <label for="datereported">Time Forwarded:</label>
            <input type="text" id="datereport" class="text" name="datereport" value="<?php echo $report['timeforward'] ?>" readonly>
